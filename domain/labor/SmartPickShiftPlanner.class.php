...
namespace SmartPick\Domain\Labor;

/**
 * SmartPickShiftPlanner - Automatisk AI-generering af vagter 4 dage forud
 */
require_once DOL_DOCUMENT_ROOT . '/user/class/user.class.php';
require_once DOL_DOCUMENT_ROOT . '/custom/smartpick/infrastructure/ai/SmartPickForecastAI.class.php';

use SmartPick\Infrastructure\AI\SmartPickForecastAI;
